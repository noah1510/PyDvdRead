    ...
    with DVD(device) as d:
        ...
        for i in range(1, d.NumberOfTitles + 1):
            ...
            try:
                ...
                title.AddChild(
                    node('picture', aspectratio=t.AspectRatio, framerate=t.FrameRate, width=t.Width, height=t.Height))
            ...
            for j in range(1, t.NumberOfAudios + 1):
                try:
                    ...
                    audio = audios.AddChild(
                        node('audio', idx=j, langcode=a.LangCode, language=a.Language, format=a.Format,
            ...
            for j in range(1, t.NumberOfSubpictures + 1):
                try:
                    ...
                    subpicture = subpictures.AddChild(
                        node('subpicture', idx=j, langcode=s.LangCode, language=s.Language))
                except Exception as e:
